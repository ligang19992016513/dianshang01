<template>
	<div class="detail">
		...
		<section class="con">
			<!-- 导航路径区域 -->
			<div class="conPoin">
				<span>{{goodsDetail.categoryView.category1Name}}</span>
				<span>{{goodsDetail.categoryView.category2Name}}</span>
				<span>{{goodsDetail.categoryView.category3Name}}</span>
			...
			<div class="mainCon">
				...
				<div class="previewWrap">
					<!--放大镜效果-->
					<Zoom :skuDefaultImg="goodsDetail.skuInfo.skuDefaultImg" />
					<!-- 小图列表 -->
					<ImageList :skuImageList="goodsDetail.skuInfo.skuImageList" />
				</div>
				<!-- 右侧选择区域布局 -->
				<div class="InfoWrap">
					<div class="goodsDetail">
						...
						<div class="priceArea">
							<div class="priceArea1">
								...
								<div class="price">
									<i>¥</i>
									<em>{{goodsDetail.skuInfo.price}}</em>
									<span>降价通知</span>
								</div>
								<div class="remark">
									<i>累计评价</i>
					...
					<div class="choose">
						<div class="chooseArea">
							...
							<dl v-for="item1 in goodsDetail.skuInfo.skuSaleAttrValueList">
								<dt class="title">{{item1.saleAttrName}}</dt>
								<dd changepirce="0" class="active">{{item1.saleAttrValueName}}</dd>
							</dl>
						</div>
						<div class="cartWrap">
							<div class="controls">
...
<script>
	...
	export default {
		...
		methods: {
			...
			tjsp() {
				this.$router.push('/AddCartSuccess/' + this.skuId+'/'+this.skuNum)
			}
		}
	}
</script>
