		...
		<header class="header">
			...
			<div class="top">
				<div class="container">
					<div class="loginList">
						<p>尚品汇欢迎您！</p>
						<p v-if="!$store.state.loginPhone">
							<span>请</span>
							<router-link to="/Login">登录</router-link>
							<router-link class="register" to="/register">免费注册</router-link>
						</p>
						<p v-else>
							<a>{{$store.state.loginPhone}}</a>
							<a @click="qk()" class="register">退出登录</a>
						</p>
					</div>
					<div class="typeList">
			...
			<div class="bottom">
				...
				<div class="searchArea">
					<form action="###" class="searchForm">
						...
						<button class="sui-btn btn-xlarge btn-danger" type="button" @click="ss()">搜索</button>
					</form>
				</div>
			</div>
		</header>
